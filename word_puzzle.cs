       ...
       // function that reading dictionary.txt and putting the words that are in dictionary.txt into dictionary array alphabetically
        ...
        static void menu()
        {
            ...
            if (info.KeyChar == '1')
            {
                ...
                if (info1.KeyChar == '1')
                {
                    pathDict = "C:\\Users\\Rıdvan\\Desktop\\dictionary.txt";
                    pathPuzzle = "C:\\Users\\Rıdvan\\Desktop\\puzzle.txt";
                    pathSolution = "C:\\Users\\Rıdvan\\Desktop\\solution.txt";
                }
                else if (info1.KeyChar == '2')
                {
                    
                    
                    pathDict = "C:\\Users\\Rıdvan\\Desktop\\dictionaryOptional.txt";
                    pathPuzzle = "C:\\Users\\Rıdvan\\Desktop\\puzzleOptional.txt";
                    pathSolution = "C:\\Users\\Rıdvan\\Desktop\\solutionOptional.txt";
                }
                else
                {
                    Console.Clear();
